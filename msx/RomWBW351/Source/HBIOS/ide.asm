...
; HL=BUFFER
;
; MSX_NOTE: 16X INI IN A LOOP IS APPR. 20% FASTER THAN INIR, ALWAYS DO 8 BIT 
;
#IFDEF MSX_MOD
IDE_GETBUF:
#IF (IDETRACE >= 3)
...
IDE_GET8F:
	; 8 BIT I/O FAST
	LD	C,(IY+IDE_IOBASE)
	LD	B,$20			; 32 X 16 = 512 BYTES (256 WORDS)
INI_LOOP:
	INI				; DO 16X INI
	INI
	INI
...
;
;
; MSX_NOTE: 16X OUTI IN A LOOP IS APPR. 20% FASTER THAN OTIR, ALWAYS DO 8 BIT 
;
#IFDEF MSX_MOD
IDE_PUTBUF:
#IF (IDETRACE >= 3)
