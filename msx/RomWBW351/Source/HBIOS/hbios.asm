...
;
; MSX_NOTE: 
; MEMORY MANAGER REQUIRES A STANDARD RAM MAPPER OF AT LEAST 256KB
; MSX ROM NOT SUPPORTED, THE MSX SLOT SYSTEM IS INCOMPATIBLE WITH ROMWBW
; TODO: WHAT HAPPENS IF YOU TRY TO SELECT A ROM BANK?
;
#IF (MEMMGR == MM_MSX)
	BIT	7,A			; BIT 7 SET REQUESTS RAM PAGE
	RET	Z			; NOT SET, NO ROM AVAILABLE / RETURN TO CALLER
	RES	7,A			; RAM PAGE REQUESTED: CLEAR ROM BIT
...
#ENDIF
;
; MSX_NOTE: MSX USES PRELOADED RAM BOOT
#IF (MEMMGR == MM_MSX)
...
#IF (MEMMGR == MM_EZ512)
	.TEXT	"EZ512$"
#ENDIF
; MSX_NOTE: ADDED MSX MEM MANAGER
#IF (MEMMGR == MM_MSX)
	.TEXT	"MSX$"
#ENDIF
