...
#ENDIF
; 
; MSX_NOTE: ADDED MODES FOR SN76489 PORTS ON RCBUS Z180 AND MSX MMM
;
#IF (SNMODE == SNMODE_RCZ180)
SN76489_PORT_LEFT	.EQU	$B0	; PORTS FOR ACCESSING THE SN76489 CHIP (LEFT)
SN76489_PORT_RIGHT	.EQU	$B4	; PORTS FOR ACCESSING THE SN76489 CHIP (RIGHT)
;	DEVECHO	"RCZ180"
#ENDIF
;
#IF (SNMODE == SNMODE_MSX)
SN76489_PORT_LEFT	.EQU	$3F	; PORTS FOR ACCESSING THE SN76489 CHIP (LEFT)
SN76489_PORT_RIGHT	.EQU	$3F	; PORTS FOR ACCESSING THE SN76489 CHIP (RIGHT)
;	DEVECHO	"MSX MMM"
#ENDIF
;
	DEVECHO	", IO_LEFT="
