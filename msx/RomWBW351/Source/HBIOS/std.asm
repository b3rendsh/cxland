...
; MSX_NOTE: ADDED MEMORY MANAGER
MM_MSX		.EQU	11		; MSX RAM MAPPER
;
; BOOT STYLE
;
...
; MSX_NOTE: ADDED MODE FOR SN76489 PORTS ON Z180 AND MSX MMM
SNMODE_RCZ180	.EQU	4		; RCBUS Z180 MODULE
SNMODE_MSX	.EQU	5		; MSX MUSICAL MEMORY MAPPER
;
