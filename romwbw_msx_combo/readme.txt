...
This folder contains Windows scripts to create a RomWBW MSX combo disk image.
...
4. Run the RomWBW build script for your platform e.g. "build msx std" or "build rcz80 std"
...
The RomWBW partition contains the standard RomWBW slices, the games slice, the msx system slice and 8 blank slices.
The msx system slice contains the CP/M loader program to start the MSX system from RomWBW.

The FAT12 system partition contains the MSX-DOS system files and loader to start RomWBW on a MSX system.
If the MSX system is started from RomWBW this will be the A-drive.
